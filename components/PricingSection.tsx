...
const PLANS: Plan[] = [
  {
    ...
    features: [
      { text: "10 AI agents" },
      { text: "1,000 AI conversations / month" },
  ...
  },
  {
    ...
    features: [
      { text: "25 AI agents" },
      { text: "5,000 AI conversations / month" },
...
function CheckIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="shrink-0 mt-0.5">
      <circle cx="8" cy="8" r="8" fill="var(--cg-success-100)" />
      <path d="M4.5 8L7 10.5L11.5 5.5" stroke="var(--cg-success-500)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
  ...
  return (
    <>
      ...
      <section className="text-center pt-16 pb-10 px-6">
        ...
        <p
          className="mb-8"
          style={{ color: "var(--cg-fg-3)", fontSize: 16, lineHeight: "24px" }}
        >
          7-day free trial &nbsp;·&nbsp; No credit card required &nbsp;·&nbsp; Cancel anytime
        </p>

        {/* Billing toggle */}
        <div className="inline-flex items-center rounded-full p-1 gap-1" style={{ background: "var(--cg-gray-100)" }}>
            ...
            >
              ...
              {b === "yearly" && (
                <span
                  ...
                  style={{ background: "var(--cg-success-100)", color: "var(--cg-success-500)" }}
                >
                  Save 10%
                </span>
              )}
      ...
      >
        <div className="mx-auto max-w-6xl px-6 h-16 flex items-center justify-between gap-4">
          <span style={{ color: "var(--cg-fg-2)", fontSize: 14, fontWeight: 500 }}>
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              style={{ color: "var(--cg-fg-3)" }}
            >
              Talk to Sales
            </a>
            <a
              href="#"
              className="inline-flex items-center px-5 py-2 rounded-md text-sm font-semibold transition-colors"
              style={{
...
function PlanCard({ plan, billing }: { plan: Plan; billing: Billing }) {
  ...
  return (
    <div
      className="relative flex flex-col rounded-xl p-8 transition-all duration-200 group"
      style={{
        background: plan.highlight ? "var(--cg-primary)" : "var(--cg-bg-card)",
        border: plan.highlight ? "none" : "1px solid var(--cg-divider)",
        boxShadow: plan.highlight ? "var(--cg-primary-shadow-lg)" : "var(--cg-shadow-card)",
      }}
    >
      {/* Most Popular badge */}
      {plan.badge && (
        <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
          <span
            ...
            style={{ background: "var(--cg-fg-on-primary)", color: "var(--cg-primary)" }}
          >
            {plan.badge}
          </span>
        </div>
      ...
      <div className="mb-6">
        <h2
          ...
          style={{ color: plan.highlight ? "rgba(255,255,255,0.95)" : "var(--cg-fg-1)" }}
        >
          {plan.name}
        </h2>
        <p
          className="text-sm leading-5"
          style={{ color: plan.highlight ? "rgba(255,255,255,0.7)" : "var(--cg-fg-3)" }}
        >
          {plan.tagline}
        </p>
      </div>
      ...
      <div className="mb-8">
        {price !== null ? (
          <div className="flex items-end gap-1">
            <span
              ...
              style={{
                fontSize: 40,
                color: plan.highlight ? "#fff" : "var(--cg-fg-1)",
            ...
            <span
              ...
              style={{ color: plan.highlight ? "rgba(255,255,255,0.6)" : "var(--cg-fg-3)" }}
            >
              / mo
            </span>
          </div>
        ...
        {billing === "yearly" && price !== null && (
          <p
            ...
            style={{ color: plan.highlight ? "rgba(255,255,255,0.55)" : "var(--cg-fg-4)" }}
          >
            Billed annually
          </p>
        )}
      ...
      <ul className="flex flex-col gap-3 mb-8 flex-1">
        {plan.features.map((f, i) => (
          <li key={i} className="flex items-start gap-2.5 text-sm">
            ...
            <span style={{ color: plan.highlight ? "rgba(255,255,255,0.85)" : "var(--cg-fg-2)" }}>
              {f.text}
              {f.note && (
                <span
                  className="ml-1 text-xs"
                  style={{ color: plan.highlight ? "rgba(255,255,255,0.5)" : "var(--cg-fg-4)" }}
                >
                  ({f.note})
                </span>
              )}
      ...
      <div className="flex flex-col gap-2">
        <a
          href={plan.ctaHref}
          className="w-full py-3 px-4 rounded-lg text-sm font-semibold text-center transition-all duration-150"
          style={
            plan.highlight
              ? {
                  background: "#fff",
